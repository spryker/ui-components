...
describe('TableDataDataConfiguratorTransformer', () => {
  let service: TableDataDataConfiguratorTransformer;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(TableDataDataConfiguratorTransformer);
