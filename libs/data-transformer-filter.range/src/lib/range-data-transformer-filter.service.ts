...
export class RangeDataTransformerFilter implements DataTransformerFilter {
      ...
      map(
        (
          transformedValuesByPropNames: Record<
            string,
            RangeDataTransformerFilterValue[]
          >,
        ) => {
  ...
  private isFilterValue(
    args: DataTransformerFilterByValue,
  ): args is RangeDataTransformerFilterValue[] {
    return args.every(
      (arg: any) =>
