...
import { provideDataTransformerConfiguratorTypes, provideDataTransformerFilters } from './tokens';
...
export class CollateDataTransformerModule {
    ...
    static withFilters(filters: DataTransformerFilterDeclaration): ModuleWithProviders<CollateDataTransformerModule> {
        return {
            ngModule: CollateDataTransformerModule,
