...
describe('CollateDataTransformerService', () => {
    ...
    beforeEach(() => {
        ...
        dataTransformerConfiguratorService = TestBed.inject(MockDataTransformerConfiguratorService);
    });
    ...
    it('transform should return filtered data by props returned from DataTransformerConfiguratorService', fakeAsync(() => {
        ...
        dataTransformerConfiguratorService.resolve.mockReturnValue(of(mockTransformerReturnData));

        const serviceObservable$ = service.transform(mockData, mockConfig, mockInjector);
    ...
    it('transform should return updated data when CollateDataConfiguratorService has been emit', fakeAsync(() => {
        ...
        const callback = jest.fn();
        const mockDataTransformerConfiguratorData$ = new BehaviorSubject(mockTransformerReturnData);

        dataTransformerConfiguratorService.resolve.mockReturnValue(mockDataTransformerConfiguratorData$);
