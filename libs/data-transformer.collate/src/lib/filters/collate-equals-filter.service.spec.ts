...
import { CollateEqualsFilter } from './collate-equals-filter.service';

class MockDataTransformer {
  transform = jest.fn();
}

describe('CollateEqualsFilter', () => {
  let service: CollateEqualsFilter;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CollateEqualsFilter);
