...
import { DataTransformerService, DataTransformer } from '@spryker/data-transformer';
import { of } from 'rxjs';
...
describe('TextDataTransformerFilterService', () => {
    ...
    it('filter method returns filtered data by value that matches with the prop value.', () => {
        ...
        const serviceObservable$ = service.filter(mockData, mockOptions, mockByValueProp, mockTransformerByPropName);
