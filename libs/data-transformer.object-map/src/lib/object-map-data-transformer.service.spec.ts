...
import { DataTransformerConfig, DataTransformerService } from '@spryker/data-transformer';
import { of } from 'rxjs';
...
class MockDataTransformerService {
    transform = jest.fn().mockImplementation((value: string, config: DataTransformerConfig) => {
...
describe('ObjectMapDataTransformerService', () => {
    ...
    it('transform method should map object and return transformed object with transformed value by config prop', () => {
        ...
        const mockReturnedData = {
            [mockTestTypeTransformerConfig.propValue]: mockTestTypeTransformerConfig.returnValue,
            [mockAnotherTestTypeTransformerConfig.propValue]: mockAnotherTestTypeTransformerConfig.returnValue,
            unchanged: 'unchanged',
        };
