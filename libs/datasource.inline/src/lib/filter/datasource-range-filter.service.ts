...
export interface DatasourceRangeFilterValue {
  from?: unknown;
  to?: unknown;
}
...
export class DatasourceRangeFilter implements DatasourceFilter {
  ...
  private isFilterValue(args: unknown[]): args is DatasourceRangeFilterValue[] {
