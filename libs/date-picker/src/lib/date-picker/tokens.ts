 ...
 */
export const DateWorkDaysToken = new InjectionToken<DateWorkDays>('DateWorkDaysToken', {
    providedIn: 'root',
 ...
 */
export const DateWorkHoursToken = new InjectionToken<DateWorkHours>('DateWorkHoursToken', {
    providedIn: 'root',
