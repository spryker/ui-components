...
describe('DateRangePickerComponent', () => {
    ...
    describe('@Input', () => {
        ...
        it('Input placeholderFrom should be bound to placeholder of first date picker', async () => {
            const host = await createComponent({ dates: mockedDates, placeholderFrom: mockedPlaceholder }, true);
            const datePickerElemFrom = host.queryCss('spy-date-picker');
        ...
        it('Input placeholderTo should be bound to placeholder of second date picker', async () => {
            const host = await createComponent({ dates: mockedDates, placeholderTo: mockedPlaceholder }, true);
            const datePickerElemTo = host.queryCss('.ant-range-picker-col:last-child spy-date-picker');
        ...
        it('Input nameFrom should be bound to name of first date picker', async () => {
            const host = await createComponent({ dates: mockedDates, nameFrom: mockedName }, true);
            const datePickerElemFrom = host.queryCss('spy-date-picker');
        ...
        it('Input nameTo should be bound to name of second date picker', async () => {
            const host = await createComponent({ dates: mockedDates, nameTo: mockedName }, true);
            const datePickerElemTo = host.queryCss('.ant-range-picker-col:last-child spy-date-picker');
        ...
        it('Input clearButton should be bound to clearButton of both date pickers', async () => {
            const host = await createComponent({ dates: mockedDates, clearButton: true }, true);
            const datePickerElemFrom = host.queryCss('spy-date-picker');
            const datePickerElemTo = host.queryCss('.ant-range-picker-col:last-child spy-date-picker');
        ...
        it('Input disabled should be bound to disabled of both date pickers', async () => {
            const host = await createComponent({ dates: mockedDates, disabled: false }, true);
            const datePickerElemFrom = host.queryCss('spy-date-picker');
            const datePickerElemTo = host.queryCss('.ant-range-picker-col:last-child spy-date-picker');
        ...
        it('Input format should be bound to format of both date pickers', async () => {
            const host = await createComponent({ dates: mockedDates, format: mockedFormat }, true);
            const datePickerElemFrom = host.queryCss('spy-date-picker');
            const datePickerElemTo = host.queryCss('.ant-range-picker-col:last-child spy-date-picker');
        ...
        it('Input time should be bound to time of both date pickers', async () => {
            const host = await createComponent({ dates: mockedDates, time: true }, true);
            const datePickerElemFrom = host.queryCss('spy-date-picker');
            const datePickerElemTo = host.queryCss('.ant-range-picker-col:last-child spy-date-picker');
