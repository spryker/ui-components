...
@Component({
    selector: 'spy-test',
    template: `
        <spy-drawer-wrapper [closeable]="closeable" [resizable]="resizable" [width]="width" (closed)="closed()">
            Content
        </spy-drawer-wrapper>
    `,
})
...
describe('DrawerWrapperComponent', () => {
    ...
    it('should render `spy-drawer-wrapper__actions` and `spy-drawer-wrapper__content` elements', () => {
        ...
        const contentElem = fixture.debugElement.query(By.css('.spy-drawer-wrapper__content'));
        const actionsElem = fixture.debugElement.query(By.css('.spy-drawer-wrapper__actions'));
    ...
    it('should show `spy-drawer-wrapper__action--close` button if @Input(closeable) is true', async () => {
        ...
        fixture.detectChanges();
        const buttonElem = fixture.debugElement.query(By.css('.spy-drawer-wrapper__action--close'));
    ...
    it('should show `spy-drawer-wrapper__action--resize` button if @Input(resizable) is true', async () => {
        ...
        fixture.detectChanges();
        const buttonElem = fixture.debugElement.query(By.css('.spy-drawer-wrapper__action--resize'));
