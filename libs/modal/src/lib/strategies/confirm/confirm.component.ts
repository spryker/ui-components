...
import { AnyModal, InferModalData, ModalRef, ModalTemplateContext } from '../../types';
...
export class ConfirmModalComponent extends asModal<ConfirmModalData, boolean>() implements ComponentModal {
    ...
    setModalRef(modalRef: ModalRef<ConfirmModalComponent, ComponentModalExtras<ConfirmModalComponent>>): void {
