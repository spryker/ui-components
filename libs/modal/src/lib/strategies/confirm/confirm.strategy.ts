...
import { ComponentModalExtras, ComponentModalRenderingRef, ComponentModalStrategy } from '../component.strategy';
...
export class ConfirmModalRenderingRef implements ComponentModalRenderingRef<ConfirmModalComponent> {
    constructor(private renderingRef: ComponentModalRenderingRef<ConfirmModalComponent>) {}
...
export class ConfirmModalStrategy extends ComponentModalStrategy<ConfirmModalComponent> {
    ...
    render(
        ...
        modalRef: ModalRef<ConfirmModalComponent, ComponentModalExtras<ConfirmModalComponent>>,
