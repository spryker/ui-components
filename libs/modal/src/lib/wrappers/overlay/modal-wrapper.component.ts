  ...
  template: `
    <div class="modal">
      <div class="modal-header" *ngIf="options.title">
        <ng-container
          *ngTemplateOutlet="headerTpl; context: headerCtx"
        ></ng-container>
      </div>
      ...
      <div class="modal-footer" *ngIf="options.footer">
        <ng-container
          *ngTemplateOutlet="footerTpl; context: footerCtx"
        ></ng-container>
      </div>
      ...
      <ng-template #renderTpl let-tpl>
        <ng-container
          *ngTemplateOutlet="tpl; context: modalContext"
        ></ng-container>
      </ng-template>
    </div>
  `,
...
export class ModalWrapperComponent {
  ...
  setModalOptions(options: ModalOptions<any>): void {
    ...
    this.headerTpl =
      typeof options.title === 'string' ? this.headerBind : this.renderTpl;
    this.headerCtx = { $implicit: options.title };

    this.footerTpl =
      typeof options.footer === 'string' ? this.renderBind : this.renderTpl;
