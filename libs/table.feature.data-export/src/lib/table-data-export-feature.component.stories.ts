...
import { TableDataExportActionHandlerService } from '@spryker/actions.table-data-export';
...
export default {
    title: 'TableDataExportFeatureComponent',
    parameters: {
        design: {
            type: 'figma',
    ...
    moduleMetadata: {
        imports: [
            ...
            TableModule.withFeatures({
                ...
                dataExport: () =>
                    import('@spryker/table.feature.data-export').then((m) => m.TableDataExportFeatureModule),
