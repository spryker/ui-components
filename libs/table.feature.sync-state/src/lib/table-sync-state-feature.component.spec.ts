...
import { TableColumnsResolverService, TableDataConfiguratorService, TableDatasourceService } from '@spryker/table';
...
describe('TableSyncStateFeatureComponent', () => {
    ...
    beforeEach(fakeAsync(() => {
        ...
        testUrlPersistenceStrategyService = TestBed.inject(MockUrlPersistenceStrategy);
    ...
    it('If dataConfiguratorService config was updated, save method of urlPersistenceStrategy has to be called', fakeAsync(() => {
        ...
        testTableFeature.feature!.setDataConfiguratorService(dataConfiguratorService);

        fixture.detectChanges();

        dataConfiguratorService.config$.next(mockedConfig);

        expect(testUrlPersistenceStrategyService.save).toHaveBeenCalledWith(mockedValue, mockedConfig);
    }));
    ...
    it('If retrieve method of urlPersistenceStrategy was called, dataConfiguratorService reset method has to be called', fakeAsync(() => {
        ...
        expect(testUrlPersistenceStrategyService.retrieve).toHaveBeenCalledWith(mockedKey);
