...
export function ColumnTypeOption(options?: ColumnTypeOptions): PropertyDecorator {
    ...
    switch (options.type) {
        ...
        case ColumnTypeOptionsType.AnyOf:
            if (!Array.isArray(options.value)) {
                throw new Error(`ColumnTypeOption: Value is not an array for type '${ColumnTypeOptionsType.AnyOf}'`);
            }
