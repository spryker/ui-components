...
import { provideRootGuard, UnsavedChangesRootToken } from './unsaved-changes-guard-root.token';
...
export class UnsavedChangesModule {
    ...
    static withGuard(guardType: Type<UnsavedChangesGuard>): ModuleWithProviders<UnsavedChangesModule> {
        return {
            ngModule: UnsavedChangesModule,
