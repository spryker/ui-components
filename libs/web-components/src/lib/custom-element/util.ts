...
export function componentDefsToDeclarations(def: WebComponentDefs): WebComponentDeclaration[] {
    return [
...
function isWebComponentDeclaration(c: WebComponentDef): c is WebComponentDeclaration {
